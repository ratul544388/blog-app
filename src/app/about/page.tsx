        ...
        <div className="flex md:items-center flex-col md:flex-row gap-8 bg-background p-5 rounded-xl">
          ...
          <div className="space-y-5">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              unfurl, and ideas take flight. Embark on an odyssey of
              imagination, discovering the artistry in every sentence. Here, the
              written word becomes an adventure, inviting you to explore the
              boundless landscapes of creativity. Join us in weaving a tapestry
              of tales, where every expression is a brushstroke on the canvas of
